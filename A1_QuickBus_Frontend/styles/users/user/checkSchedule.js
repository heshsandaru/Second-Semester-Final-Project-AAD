    ...
    schedules.forEach(schedule => {
      ...
      <div class="card shadow-lg mb-3">
          ...
          <div class="card-footer d-flex justify-content-between align-items-center bg-dark text-white">
              ...
              data-price="${schedule.price}">Book Seat</button>
          </div>
      </div>
    `;
...
document.addEventListener('click', function (e) {
    if (e.target && e.target.classList.contains('bookingSeatBtn')) {
        ...
        document.getElementById('scheduleIdDisplay').innerText = `Schedule ID: ${scheduleId}`;
        ...
        if (seatSection) {
            document.querySelector("#seat-section").style.display="flex"
            document.querySelector(".banner").style.display = "none";
